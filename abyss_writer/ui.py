...
def build_ui():
    with gr.Blocks(title="Abyss Writer") as app:
        ...
        with gr.Group():
            ...
            with gr.Accordion("➕ 새 프로젝트 생성", open=False):
                with gr.Row():
                    new_title = gr.Textbox(label="프로젝트 제목", placeholder="예: 심연의 메아리")
                    new_genre = gr.Textbox(label="장르", placeholder="예: SF 스릴러")
                    btn_create_project = gr.Button("생성하기", variant="primary")
